...
public interface DruidParser {
	...
	* @throws
	 */
	public void parser(Configurations configurations, SQLStatement stmt,DruidSchemaStatVisitor schemaStatVisitor)throws SQLNonTransientException;
	 ...
	 */
	public void statementParse(Configurations configurations, SQLStatement stmt) throws SQLNonTransientException;
	...
	* @throws
	 */
	public void visitorParse(SQLStatement stmt,DruidSchemaStatVisitor visitor) throws SQLNonTransientException;

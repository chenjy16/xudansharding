...
public class DruidStatementWrapper extends AbstractStatement implements Statement ,LifeCycle{
	
	DruidStatementContextBuilder builder;
	DruidConnectionWrapper connection;
	ResultSet resultSet;
	int updateCount;
	...
	public DruidStatementWrapper(DruidConnectionWrapper connection,
			DruidStatementContextBuilder builder) {
		this.builder = builder;
		this.connection = connection;
		DruidStatementContext context = new DruidStatementContext();
	...
	public ResultSet executeQuery(String sql) throws SQLException {
		DruidStatementContext context = builder.build(sql,DruidStatementContext.getContext());

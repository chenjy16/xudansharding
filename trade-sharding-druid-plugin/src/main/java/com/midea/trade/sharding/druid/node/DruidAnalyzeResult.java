...
public class DruidAnalyzeResult implements AnalyzeResult{
	...
	public DruidAnalyzeResult() {
		this(null);
	}

	public DruidAnalyzeResult(Object treeNode) {
	...
	public String toString() {
		return "DruidAnalyzeResult [tableInfos=" + tableInfos
	...
	public AnalyzeResult clone(){
		DruidAnalyzeResult result=new DruidAnalyzeResult();
		return null;
	}
}
